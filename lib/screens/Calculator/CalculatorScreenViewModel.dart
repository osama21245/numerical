...
import 'package:numerical_analisis/screens/Calculator/CalculatorScreenNavigator.dart';
...
class CalculatorScreenViewModel extends ChangeNotifier {
  ...
  void onPressBack() {
    ...
    if (titleOnScreen != 'Enter Equation') {
      ...
      if (titleOnScreen[titleOnScreen.length - 1] == ")") {
      ...
      } else if (titleOnScreen[titleOnScreen.length - 1] == "(") {
        // check if the last char is (
        openingBracketCount--;
        titleOnScreen = titleOnScreen.substring(0, titleOnScreen.length - 1);
        ...
        if (titleOnScreen.isNotEmpty) {
          ...
          if (titleOnScreen[titleOnScreen.length - 1] == 'n' ||
              titleOnScreen[titleOnScreen.length - 1] == 's') {
            titleOnScreen =
                titleOnScreen.substring(0, titleOnScreen.length - 3);
          }
        }
      } else {
        titleOnScreen = titleOnScreen.substring(0, titleOnScreen.length - 1);
