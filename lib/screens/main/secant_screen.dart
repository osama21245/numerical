...
import 'package:numerical_analisis/screens/result/secant_result_screen.dart';
...
class SecantScreen extends StatefulWidget {
  @override
  _SecantScreenState createState() => _SecantScreenState();
}
...
class _SecantScreenState extends State<SecantScreen> {
  ...
  TextEditingController xiMinus = TextEditingController();
    ...
    return Scaffold(
        ...
        body: BlocConsumer<OperationsBloc, OperationsState>(
          listener: (context, state) {
            if (state is OperationsSecantSucess) {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const SecantResultScreen()));
            } else {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      keyboardType: TextInputType.number,
                      decoration:
                          const InputDecoration(labelText: 'Enter ximinus'),
                    ),
                    const SizedBox(height: 20.0),
                    Container(
                      height: 700,
                    ...
                    ElevatedButton(
                      onPressed: () {
                        operationsBloc.add(OperationsSecant(
                            xiMinus: double.parse(xiMinus.text),
