...
import 'package:numerical_analisis/screens/result/simplefixedpoint_result_screen%20copy.dart';
...
class NewtonScreen extends StatefulWidget {
  @override
  _NewtonScreenState createState() => _NewtonScreenState();
}
...
class _NewtonScreenState extends State<NewtonScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text("Newton Fixed Point"),
        ),
        body: BlocConsumer<OperationsBloc, OperationsState>(
          listener: (context, state) {
            if (state is OperationsNewtonSuccess) {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const NewtonResultScreen()));
            } else {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        operationsBloc.add(OperationsNewton(
