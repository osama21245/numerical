...
class FalsePostitionScreen extends StatefulWidget {
  const FalsePostitionScreen({super.key});

  @override
  _FalsePostitionScreenState createState() => _FalsePostitionScreenState();
}

class _FalsePostitionScreenState extends State<FalsePostitionScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    TextField(
                      ...
                      decoration: const InputDecoration(labelText: 'Enter xl'),
                    ),
                    const SizedBox(height: 20.0),
                    TextField(
                      controller: xuController,
                      keyboardType: TextInputType.number,
                      decoration: const InputDecoration(labelText: 'Enter xu'),
                    ),
                    const SizedBox(height: 20.0),
                    TextField(
                    ...
                    ElevatedButton(
                      onPressed: () {
                        operationsBloc.add(OperationsFalsePosition(
